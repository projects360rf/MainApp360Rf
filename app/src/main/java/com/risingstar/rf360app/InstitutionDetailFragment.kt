...
class InstitutionDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_institution_detail, container, false)
        ...
        frameInstitution = view.findViewById(R.id.frameInstitution)
        ...
        sliderAdapter = SliderAdapter(activity as Context,sliderArrayList)
        ...
        btnJoin.setOnClickListener {
            ...
            fragmentManager?.beginTransaction()?.replace(R.id.frameInstitution,joinUsFragment)
                ?.commit()
        }
